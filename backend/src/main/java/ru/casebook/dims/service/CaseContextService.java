...
public class CaseContextService {
    private final CaseRepository cases; private final IncidentSceneRepository scenes;
    private final CurrentUserService currentUsers; private final AuditService audit;
    public CaseContextService(CaseRepository cases, IncidentSceneRepository scenes, CurrentUserService currentUsers, AuditService audit) {
        this.cases=cases; this.scenes=scenes; this.currentUsers=currentUsers; this.audit=audit;
    }
